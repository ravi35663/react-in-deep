/*
==> CDN:
    ->  Mainly speaking CDN is a bunch of servers placed in different locations all over the world. 
        To minimize the physical distance between your website and your user you can choose to deliver 
        it through CDN which would cache a copy of your content on each of their servers.

==> Apart from world distribution and enchanted latency, there are few more benefits that CDN can 
    provide:
